...
public enum ExceptionDetails {
    ...
    NOT_FOUND_ERROR("0000", "식별할 수 없는 에러입니다.", 400, NotFoundErrorException.class),

    LOGIN_ID_EXISTS("0001", "이미 존재하는 아이디입니다.", 404, LoginIdExistException.class),
    MAIL_EXISTS("0002", "이미 존재하는 메일입니다.", 404, MailExistException.class),
    LOGIN_FAIL("0003", "아이디 또는 비밀번호를 확인해주세요.", 400, LoginFailException.class),
    MEMBER_NOT_FOUND("0004", "존재하지 않는 회원입니다.", 404, MemberNotFoundException.class),

    GOAL_TYPE_DUPLICATION("0005", "같은 종류의 목표가 이미 존재합니다.", 409, GoalTypeDupException.class),
    GOAL_NOT_FOUND("0006", "목표를 찾을 수 없습니다.", 404, GoalNotFoundException.class),
    GOAL_TIME_OUT_OF_RANGE("0007", "지정된 시간 범위를 벗어납니다. (일간 : 24시간, 월간 1000시간)", 409, GoalTimeOutOfRangeException.class),
    GOAL_COUNT_OUT_OF_RANGE("0008", "지정된 개수 범위를 벗어납니다. (일간, 월간 : 100000000개)", 409, GoalCountOutOfRangeException.class);
